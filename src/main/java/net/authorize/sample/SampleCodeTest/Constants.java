...
public final class Constants {
	...
	public static final String TRANSACTION_KEY = "4Ktq966gC55GAX7S";
	public static final String TRANSACTION_ID = "123456";
	public static final String PAYER_ID = "6ZSCSYG33VP8Q";
	public static final String CONFIG_FILE = "./src/main/java/net/authorize/sample/SampleCodeTest/SampleCodeList.txt";
}
